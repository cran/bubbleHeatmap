...
```
### One-step Figure
The nightingale function wraps the formatData, multiPlotInput, bubbleHeatmapList 
and nightingalePlot functions listed below, applying default settings to build 
...
### Prepare Input for plotting function (multPlotInput) 
...
The Nightingale function takes a list of plot trees and a legend tree, and 
